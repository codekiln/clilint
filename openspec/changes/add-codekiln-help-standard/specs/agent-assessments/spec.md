...
Request and required Skill. After receiving an Assessment, the CLI SHALL
return a Check Result bound to the request.
...
- **THEN** the report contains the check request, required Skill, and an Awaiting Assessment outcome
...
- **THEN** the Checker CLI rejects the assessment and the check remains Awaiting Assessment
